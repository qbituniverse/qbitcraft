...
public class QbitcraftClient extends QbitcraftConnection {
	...
	public QbitcraftClient(String username, MultiplayerDisplay menu, String hostName) { this(username, menu, hostName, DEFAULT_CONNECT_TIMEOUT); }
	public QbitcraftClient(String username, MultiplayerDisplay menu, String hostName, int connectTimeout) {
		super("QbitcraftClient", openSocket(hostName, menu, connectTimeout));
		this.menu = menu;
		Game.ISONLINE = true;
		Game.ISHOST = false;
