...
import qbitcraft.item.PowerGloveItem;
...
public class QbitcraftServerThread extends QbitcraftConnection {
	...
	private QbitcraftServer serverInstance;
	...
	QbitcraftServerThread(Socket socket, QbitcraftServer serverInstance) {
		super("QbitcraftServerThread", socket);
		valid = true;
	...
	QbitcraftServerThread(RemotePlayer player, QbitcraftServer server) {
		super("QbitcraftServerThread", null);
		valid = false;
		this.client = player;
