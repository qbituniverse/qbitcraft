...
import qbitcraft.gfx.*;
import qbitcraft.gfx.Ellipsis.DotUpdater.TickUpdater;
...
public class Renderer extends Game {
	...
	private static void initSpriteSheets() throws IOException {
		...
		SpriteSheet itemSheet = new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream("/textures/items.png")));
		SpriteSheet tileSheet = new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream("/textures/tiles.png")));
		SpriteSheet entitySheet = new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream("/textures/entities.png")));
		SpriteSheet guiSheet = new SpriteSheet(ImageIO.read(Game.class.getResourceAsStream("/textures/gui.png")));
