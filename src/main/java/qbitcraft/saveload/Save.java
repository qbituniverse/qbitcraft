...
import qbitcraft.entity.furniture.Crafter;
import qbitcraft.entity.furniture.DeathChest;
import qbitcraft.entity.furniture.DungeonChest;
import qbitcraft.entity.furniture.Lantern;
import qbitcraft.entity.furniture.Spawner;
import qbitcraft.entity.mob.AirWizard;
import qbitcraft.entity.mob.EnemyMob;
import qbitcraft.entity.mob.Mob;
import qbitcraft.entity.mob.Player;
import qbitcraft.entity.mob.RemotePlayer;
import qbitcraft.entity.particle.Particle;
...
public class Save {
	...
	public static String extension = ".qbitsave";
	...
	public Save(String worldname, QbitcraftServer server) {
		this(new File(Game.gameDir+"/saves/" + worldname + "/"));
	...
	private void writeServerConfig(String filename, QbitcraftServer server) {
