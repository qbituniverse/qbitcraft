...
public class Color {
	...
	*/
	...
	/*
		...
		rgbQbitcraft = int using 12 bits for r, g, and b, 4 bits each, and one for transparency
	...
	*/
	...
	/// this turns a 25-bit qbitcraft color into a 24-bit rgb color.
	protected static int upgrade(int rgbQbitcraft) {

		return rgbQbitcraft & 0xFF_FF_FF;
	}
