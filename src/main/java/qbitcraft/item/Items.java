...
public class Items {
	...
	/**
		...
		This class is meant to define all the different kinds of items in qbitcraft. Item(Type).java might be what maps the different item sprites in the spritesheet to a name, but it doesn't really define anything final. This class has all the items you could possibly have, and every form of them, more or less.
